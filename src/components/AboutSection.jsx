        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              ...
              technologies. I have hands-on experience through academic projects
              and self-driven development in frontend and backend web
              technologies. I am eager to apply my skills, learn continuously,
